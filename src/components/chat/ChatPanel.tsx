...
export type ChatPanelProps = {
  ...
  userId: string
  /** Small, app-owned context for the current story location/card. */
...
const DEFAULT_PROMPTS = [
  'Help me strengthen this story premise',
  'Suggest missing worldbuilding cards',
  'Find weak spots in my canon',
]
...
export function ChatPanel({
  ...
  emptyStateTitle = 'Ready to forge?',
  emptyStateDescription = 'I can help shape worlds, characters, plot points, and chapter drafts while keeping changes reviewable.',
  className,
  header,
  compact = false,
  disabled = false,
